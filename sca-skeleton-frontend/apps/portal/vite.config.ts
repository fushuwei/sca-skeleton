...
import { subsetMaterialSymbols } from "@repo/ui/vite-plugins/subset-material-symbols";
...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      ...
      overrideFontDisplay(),
      // 仅 build 时子集化 Material Symbols 字体（5MB → ~140KB），dev 跳过用完整字体
      subsetMaterialSymbols(),
      vue({
