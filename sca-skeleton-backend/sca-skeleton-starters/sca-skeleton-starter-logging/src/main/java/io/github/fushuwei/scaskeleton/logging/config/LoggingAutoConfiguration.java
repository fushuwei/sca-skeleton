 ...
 * 依赖 JsonMapper（由 Web Starter 或 Spring Boot 自动装配）、
...
public class LoggingAutoConfiguration {
     ...
     *
     * @param jsonMapper           Jackson 序列化器，用于序列化请求参数与响应结果
    ...
    public OperationLogAspect operationLogAspect(
        ...
        return new OperationLogAspect(jsonMapper, currentUserProvider, operationLogHandler);
    }
}
