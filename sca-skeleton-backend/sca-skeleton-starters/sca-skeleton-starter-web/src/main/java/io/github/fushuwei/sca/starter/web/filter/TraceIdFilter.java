 ...
 * TraceId 注入过滤器。
 * <p>
 * 每个 HTTP 请求进入时，从请求头 {@link TraceContext#HEADER_KEY} 中读取 TraceId；
...
public class TraceIdFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        String traceId = request.getHeader(TraceContext.HEADER_KEY);
        ...
        response.setHeader(TraceContext.HEADER_KEY, traceId);
