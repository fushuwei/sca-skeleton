 ...
 * （认证服务在颁发令牌时基于本服务的 RBAC 数据装配 {@code authorities} 业务 claim）。
 * <p>
 * 安全模型：本服务以 OAuth2 资源服务器角色运行，通过 {@code spring-boot-starter-oauth2-resource-server}
 * 校验不透明 access_token（Redis 本地自省），并基于 introspect 响应中的 authorities
...
@MapperScan("io.github.fushuwei.scaskeleton.system.mapper")
